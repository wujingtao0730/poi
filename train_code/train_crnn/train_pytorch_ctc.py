...
config.saved_model_prefix = 'CRNN-1028'
#config.train_infofile = ['path_to_train_infofile1.txt','path_to_train_infofile2.txt']
config.train_infofile = '/home/SyntheticChineseStringDataset/train.txt'
config.val_infofile = '/home/SyntheticChineseStringDataset/train.txt'
